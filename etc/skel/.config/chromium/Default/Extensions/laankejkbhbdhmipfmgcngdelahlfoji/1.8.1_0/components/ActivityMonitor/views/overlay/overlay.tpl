<link rel="stylesheet" href="{{extensionURL}}common/css/content.css" type="text/css" />
<div id="StayFocusd-still-there" class="inactive">
    <div>
        <img src="{{extensionURL}}common/img/logo_full.png" title="StayFocusd" alt="StayFocusd" class="StayFocusd-smartBombed" />
    </div>
