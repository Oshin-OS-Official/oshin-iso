<ul id="header" class="flex justify-between items-center">
    <li id="logo"><img src="/common/img/logo_popup.png" title="StayFocusd" alt="StayFocusd"></li>
    <li id="close-button" class="line-height-[unset]">
        <a href="#" class="close text-[unset]" data-i18n="close">close</a>
    </li>
</ul>
...
<ul id="body">
    ...
    <li id="current-domain">
        <div class="sf-label" data-i18n="currentlyOn">You are currently on:</div>
    ...
    <li id="left-col">
        <ul class="options">
            <li class="option">
                <a href="#" id="block-entire" title="Block all pages on this site" data-analytics-click="CLICK_POPUP_BLOCK_ENTIRE_SITE">
    ...
    <li id="advanced-options">
        <ul class="options">
            ...
            <li class="custom">
                <div class="sf-label" data-i18n="enterCustomURL">Enter a custom url</div>
    ...
    <li id="footer">
        <ul class="options">
            <li class="more-options">
                <img class="inline-block" src="/common/img/eye_16x16_nuclear.png" alt="Nuclear Option" id="nuclearOptionIcon" />
