...
class AWClient {
    ...
    getBuckets() {
        return __awaiter(this, void 0, void 0, function* () {
            const buckets = (yield this.req.get("/0/buckets/")).data;
    ...
    getBucketInfo(bucketId) {
        return __awaiter(this, void 0, void 0, function* () {
            const bucket = (yield this.req.get(`/0/buckets/${bucketId}`)).data;
    ...
    getEvents(bucketId, params) {
        return __awaiter(this, void 0, void 0, function* () {
            const events = (yield this.req.get("/0/buckets/" + bucketId + "/events", { params })).data;
    ...
    send_heartbeat(bucketId, pulsetime, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const heartbeat = (yield this.req.post(url, data)).data;
...
},{"retry":31}],30:[function(require,module,exports){
...
},{"../aw-client-js/out/aw-client.js":28,"p-retry":29,"ua-parser-js":34}],36:[function(require,module,exports){
/*
